...
| call-023 | callback_false_trigger | PASS |
| call-024 | callback_false_trigger | PASS |
| call-025 | callback_false_trigger | PASS |
| call-026 | callback_false_trigger | PASS |
...
| call-033 | callback_request_explicit | PASS |
...
| call-038 | callback_false_trigger | PASS |
| call-039 | callback_false_trigger | PASS |
| call-040 | callback_false_trigger | PASS |
| call-041 | callback_false_trigger | PASS |
| call-042 | callback_false_trigger | FAIL |
| call-043 | callback_false_trigger | PASS |
| call-044 | callback_false_trigger | PASS |
| call-045 | callback_false_trigger | PASS |
| call-046 | callback_false_trigger | PASS |
| call-047 | callback_false_trigger | FAIL |
...
| call-059 | callback_request_explicit | PASS |
| call-060 | callback_request_explicit | PASS |
| call-061 | callback_request_explicit | PASS |
| call-062 | callback_request_explicit | PASS |
| call-063 | callback_request_explicit | PASS |
| call-064 | callback_request_explicit | PASS |
| call-065 | callback_request_explicit | PASS |
| call-066 | callback_false_trigger | PASS |
| call-067 | callback_false_trigger | PASS |
| call-068 | callback_false_trigger | PASS |
| call-069 | callback_false_trigger | PASS |
| call-070 | callback_false_trigger | FAIL |
...
- **Callback recall**: 100% (n=44) — target: ≥90%
- **Callback precision**: 94% (n=47) — target: ≥95%
- **Phone extraction accuracy**: 100% (n=44) — target: no target yet
- **Callback false-trigger rate**: 8% (n=38) — target: no target yet
...
```json
{
  "answer": "A copyright protects tangible original works, like photos or text descriptions, while a trademark is a symbol or word that identifies and distinguishes a business or product from others.",
  "sources": [
    "assets/free/compliance.txt",
    "assets/free/compliance.txt",
    "assets/free/compliance.txt",
...
### call-059 (callback_request_explicit)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode",
...
### call-060 (callback_request_explicit)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode",
...
### call-061 (callback_request_explicit)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode",
  "extracted_phone": "0452 222 333",
  "phone_ok": true
}
```

### call-062 (callback_request_explicit)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode",
  "extracted_phone": "0452 121 343",
  "phone_ok": true
}
```

### call-063 (callback_request_explicit)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode",
  "extracted_phone": "0452 909 808",
  "phone_ok": true
}
```

### call-064 (callback_request_explicit)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode",
  "extracted_phone": "0452 777 888",
  "phone_ok": true
}
```

### call-065 (callback_request_explicit)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode",
  "extracted_phone": "0452 555 123",
  "phone_ok": true
}
```

### call-066 (callback_false_trigger)
```json
{
  "actually_fired": false,
  "final_node": "AuthenticatedUserNode"
...
### call-067 (callback_false_trigger)
```json
{
  "actually_fired": false,
  "final_node": "AuthenticatedUserNode"
...
### call-068 (callback_false_trigger)
```json
{
  "actually_fired": false,
  "final_node": "AuthenticatedUserNode"
...
### call-069 (callback_false_trigger)
```json
{
  "actually_fired": false,
  "final_node": "AuthenticatedUserNode"
...
### call-070 (callback_false_trigger)
```json
{
  "actually_fired": true,
  "final_node": "CallCustomerNode"
