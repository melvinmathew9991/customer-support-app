...
```json
{
  "answer": "You can update your bank account information in your Shopify Payments settings.",
  "sources": [
    "assets/free/payments.txt",
    "assets/free/payments.txt",
    "assets/free/payments.txt",
...
```json
{
  "answer": "A copyright protects tangible original works, like photos or text descriptions on an online store, whereas a trademark is a symbol or word that identifies and distinguishes a business or product from other businesses or products.",
  "sources": [
    "assets/free/compliance.txt",
    "assets/free/compliance.txt",
    "assets/free/compliance.txt",
