...
| call-031 | callback_request_indirect | FAIL |
...
- **Callback recall**: 97% (n=37) — target: ≥90%
- **Callback precision**: 95% (n=38) — target: ≥95%
- **Phone extraction accuracy**: 100% (n=36) — target: no target yet
- **Callback false-trigger rate**: 6% (n=33) — target: no target yet
