...
- **Fails-safe rate**: 100% (n=4) — target: 100%
- **Retrieval recall@k**: 100% (n=39) — target: ≥90%
- **Tier-leakage rate**: 0% (n=39) — target: 0%
- **Callback recall**: 100% (n=37) — target: ≥90%
- **Callback precision**: 95% (n=39) — target: ≥95%
- **Phone extraction accuracy**: 100% (n=37) — target: no target yet
