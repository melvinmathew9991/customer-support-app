...
| Tests | `tests/**/test_*.py` | 3,216 | 446 tests across 20 files, none needing a live model: agents (`test_call_customer_edge` 56, `test_user_info_edge` 9, `test_call_customer_node` 4, `test_authenticated_user_node` 2), domain (`test_chat` 4), graph (`test_retrieval_guard` 24, `test_node` 5, `test_text_based_edge` 3, `test_edge` 2), tools (`test_user_store` 35, `test_rag_responder` 8 - `test_user_info_db.py` was retired in Sprint 4 with the mock DB it tested), eval (`test_golden_set` 176, `test_run_eval_scoring` 19, `test_eval_gate` 10), and top level (`test_session_store` 23, `test_pipeline_persistence` 25, `test_cli` 14, `test_config` 12, `test_app_sessions` 14, `test_pipeline_timeout` 1) |
...
├── tests/                 # 446 unit tests (deterministic logic only)
...
| Metric | Value |
|---|---|
| Unit tests passing | 446/446 (20 files) |
