...
| 3 | Sprint 2 milestone still open; #29 had no milestone; no `v0.1.0-sprint2` tag although `Git-Workflow.md` requires one | Fixed at close-out: #29, #11 and #30 assigned to Sprint 2; #5, #17, #23 and the new #33 moved to a new Sprint 3 milestone; Sprint 2 closed and tagged |
